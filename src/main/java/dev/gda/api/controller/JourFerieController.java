...
public class JourFerieController {
	 ...
	 * 
	 * @return Une liste de tous les jours fériés si elle existe une liste vide
	 *         sinon
	 */
	@GetMapping
	 ...
	 */
	@PostMapping
	public JourFerie ajouterJourFerie(@RequestBody @Valid JourFerie jourFerie, HttpServletResponse resp)
			throws JourFerieException {
	...
	public void supprimerJoursFerie(@PathVariable Optional<Integer> jourFerieId, HttpServletResponse response)
			throws JourFerieException {
